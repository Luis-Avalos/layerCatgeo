            ...
            <tr>
                <td valign="top" style="padding:0;Margin:0">
                    ...
                    <table cellpadding="0" cellspacing="0" align="center" class="l" role="none"
                        ...
                        <img src="https://fpdtjni.stripocdn.email/content/guids/CABINET_5d9543e827a065c12d9b79a3da06bbaa662dffae34e3fbee6681ded4674e15b8/images/geomatica.png" alt="Geomática" width="380" class="adapt-img" style="display:block;font-size:14px;border:0;outline:none;text-decoration:none;margin:0">
...
export const sendAsignacionCapasEmail = async ({
  ...
  // Construir HTML dinámico para workspaces y capas
  const workspacesLayersHtml = Object.entries(permisosAgrupados)
    .map(([workspace, layers]) => {
      const layersHtml = layers.map(layer => `
        <li style="color:#333333;margin:0px 0px 15px;font-size:14px;text-align:left;line-height:28px">
          <p style="mso-margin-top-alt:15px;Margin:0;mso-line-height-rule:exactly;mso-margin-bottom-alt:15px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:28px;letter-spacing:0;color:#333333;font-size:14px;text-align:left">
            <strong style="font-weight:700 !important">${layer}</strong>
          </p>
        </li>
      `).join("");

      return `
        <h3 style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:bold;line-height:40px;color:#333333;text-align:left">
          Workspace: 
        </h3>
    
        <li style="color:#333333;margin:0px 0px 15px;font-size:14px;text-align:left;line-height:28px">
          <p style="mso-margin-top-alt:15px;Margin:0;mso-line-height-rule:exactly;mso-margin-bottom-alt:15px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:28px;letter-spacing:0;color:#333333;font-size:14px;text-align:left">
            <strong style="font-weight:700 !important">${workspace}</strong>
          </p>
        </li>
...
<html dir="ltr" xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" lang="es">
 <head>
  ...
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta content="telephone=no" name="format-detection">
  <title>Asignación de capas</title>
  <style type="text/css">
    .rollover:hover .rollover-first {
      max-height:0px!important;
      display:none!important;
    ...
    @media only screen and (max-width:600px) {
      ...
      *[class="gmail-fix"] { display:none!important }
      ...
      .bf p, .bf a { font-size:16px!important }
      .be p, .be a { font-size:14px!important }
      .bd p, .bd a { font-size:12px!important }
      .f .rollover:hover .rollover-second, 
      .i .rollover:hover .rollover-second, 
      .h .rollover:hover .rollover-second { display:inline!important }
      .bb { display:inline-table }
      .p table, .q table, .r table, .p, .r, .q { width:100%!important; max-width:600px!important }
      .adapt-img { width:100%!important; height:auto!important }
      .h-auto { height:auto!important }
      .a .d, .a .d * { font-size:18px!important; line-height:150%!important }
      .a .b, .a .b * { font-size:16px!important }
    }
    @media screen and (max-width:384px) {
 ...
 <body class="body" style="width:100%;height:100%;font-family:arial, 'helvetica neue', helvetica, sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0">
  <div dir="ltr" class="es-wrapper-color" lang="es" style="background-color:#FAFAFA">
   <table width="100%" cellspacing="0" cellpadding="0" class="es-wrapper" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px;padding:0;Margin:0;width:100%;height:100%;background-repeat:repeat;background-position:center top">
      <tr>
      <td valign="top" style="padding:0;Margin:0">
       <table cellpadding="0" cellspacing="0" align="center" class="p" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px;width:100%;table-layout:fixed !important">
          <tr>
          <td align="center" style="padding:0;Margin:0">
           <table align="center" cellpadding="0" cellspacing="0" bgcolor="#00000000" class="bf" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px;background-color:transparent;width:600px" role="none">
              <tr>
                   ...
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                      ...
                      <td align="center" class="bd" style="padding:0;Margin:0">
                        <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:18px;letter-spacing:0;color:#CCCCCC;font-size:12px">
                          <a target="_blank" href="https://camioncito.zapopan.gob.mx/landing/login.html" style="mso-line-height-rule:exactly;text-decoration:underline;color:#CCCCCC;font-size:12px">Ver en línea</a>
                        </p>
                       </td>
                       </tr>
                    </table>
       ...
       <table cellpadding="0" cellspacing="0" align="center" class="q" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px;width:100%;table-layout:fixed !important;background-color:transparent;background-repeat:repeat;background-position:center top">
           <tr>
          <td align="center" style="padding:0;Margin:0">
           <table bgcolor="#ffffff" align="center" cellpadding="0" cellspacing="0" class="bg" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px;background-color:#ffffff;width:600px" role="none">
               <tr>
       ...
       <table cellpadding="0" cellspacing="0" align="center" class="p" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px;width:100%;table-layout:fixed !important">
         <tr class="es-visible-simple-html-only">
          <td align="center" class="es-stripe-html" style="padding:0;Margin:0">
           <table bgcolor="#ffffff" align="center" cellpadding="0" cellspacing="0" class="bf" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px;background-color:#FFFFFF;width:600px">
               <tr>
              <td align="left" bgcolor="#ffffff" style="padding:0 20px 30px;Margin:0;background-color:#ffffff">
               <table cellpadding="0" cellspacing="0" width="100%" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                   <tr>
                  <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                   <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px;border-radius:5px;border-collapse:separate" role="presentation">
                       <tr>
                      <td align="center" style="padding:20px;Margin:0;font-size:0">
                       <table border="0" width="100%" height="100%" cellpadding="0" cellspacing="0" class="bb" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                           <tr>
                          <td style="padding:0;Margin:0;height:0px;width:100%;margin:0px;border-bottom:1px solid #cccccc;background:none"></td>
                           </tr>
                        </table>
                       ...
                       <tr>
                      <td align="center" class="bj bi a" style="Margin:0;padding:5px 40px">
                        <h4 style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:24px;font-style:normal;font-weight:normal;line-height:28.8px;color:#e69138">
                          <strong style="font-weight:700 !important">Se te han asignado nuevos permisos</strong>
                        </h4>
                        <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#e69138;font-size:14px"><br></p>
                       </td>
                       </tr>
                       <tr>
                      <td align="center" style="padding:0;Margin:0;font-size:0">
                        <img src="https://fpdtjni.stripocdn.email/content/guids/CABINET_baef705ee3104830b958a094d670959cbfb58dd92024bc5ed314b367aa2b964f/images/captura_de_pantalla_20260424_122339.png" alt="" width="100" title="" style="display:block;font-size:14px;border:0;outline:none;text-decoration:none;margin:0">
                       </td>
                       </tr>
                       <tr>
                      <td align="center" class="a" style="padding:30px 25px 0;Margin:0">
                        <h6 style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:16px;font-style:normal;font-weight:normal;line-height:19.2px;color:#333333">
                        ...
                        <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px;text-align:left">
                          Hola&nbsp;<strong style="font-weight:700 !important">${nombreCompleto}</strong>,
                        </p>
                        <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px;text-align:left">
                          Se te han asignado nuevas capas dentro de la Plataforma Catálogo.
                        </p>
                        <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px;text-align:left"><br></p>
                        
                        ${workspacesLayersHtml}
                        
                        <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:28px;letter-spacing:0;color:#333333;font-size:14px;text-align:left">
                          <strong style="font-weight:700 !important"><br></strong>
                        </p>
                        <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:28px;letter-spacing:0;color:#333333;font-size:14px;text-align:left">
                          <strong style="font-weight:700 !important">Los permisos te fueron asignados por: </strong>${asignadoPor}
                        </p>
                        <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:28px;letter-spacing:0;color:#333333;font-size:14px;text-align:left">
                          <strong style="font-weight:700 !important">Fecha de asignación: </strong>${fechaAsignacion}
                        </p>
                        <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:28px;letter-spacing:0;color:#333333;font-size:14px;text-align:left">
                        ...
                        <div style="text-align:center;margin:30px 0;">
                          <a href="https://camioncito.zapopan.gob.mx/landing/login.html" 
                             style="background:#E69138;color:#ffffff;padding:12px 25px;text-decoration:none;border-radius:6px;font-weight:bold;display:inline-block;">
                            Iniciar Sesión
                          </a>
                        </div>
                        ...
                        <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                          ...
                          <strong style="font-weight:700 !important">Unidad de Geomática</strong>
                        </p>
                        <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px"><br></p>
                       </td>
                       </tr>
       ...
       <table cellpadding="0" cellspacing="0" align="center" class="r" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px;width:100%;table-layout:fixed !important;background-color:transparent;background-repeat:repeat;background-position:center top">
           <tr>
          <td align="center" style="padding:0;Margin:0">
           <table align="center" cellpadding="0" cellspacing="0" class="be" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px;background-color:transparent;width:640px" role="none">
               <tr>
              <td align="left" bgcolor="#e69138" style="Margin:0;padding:20px;background-color:#e69138">
               <table cellpadding="0" cellspacing="0" width="100%" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                   <tr>
                  <td align="left" style="padding:0;Margin:0;width:600px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                       <tr>
                      <td align="center" class="a" style="padding:0 0 35px;Margin:0">
                        <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:18px;letter-spacing:0;color:#333333;font-size:12px"><br></p>
                        <h6 class="d" style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:18px;font-style:normal;font-weight:normal;line-height:21.6px;color:#ffffff">
                   ...
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                      ...
                      <td align="center" class="bd" style="padding:0;Margin:0">
                        <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:18px;letter-spacing:0;color:#CCCCCC;font-size:12px">
                          ...
                          <a href="#" target="_blank" style="mso-line-height-rule:exactly;text-decoration:underline;color:#CCCCCC;font-size:12px">Cancelar suscripción</a>.
                        </p>
                       </td>
                       </tr>
                    </table>
...
//             <strong style="color:#3d85c6;">Espacio de trabajo: </strong>${workspace}
//             <strong style="color:#3d85c6;">Capas asignadas: </strong>
//           </td>
//         </tr>
//         ${layersHtml}
//       `;
...
// <p>
// Ya puedes iniciar sesión y consultar tus herramientas disponibles desde la aplicación web.
// </p>
